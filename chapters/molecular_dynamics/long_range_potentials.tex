...
\begin{wrapfigure}[16]{r}{0.45\textwidth}
  ...
  \captionof{figure}{In the Ewald summation, the system is repeated periodically in all directions.}
  \label{fig:ewald}
\end{wrapfigure}
% \end{minipage}\hfill
%\begin{minipage}{.48\textwidth}
...
\begin{minipage}{.98\textwidth}
  ...
  \captionof{figure}{Screening of point-like charges. \citep{sim_liq}}
...
\begin{minipage}{.38\textwidth}
  ...
  \captionof{figure}{Illustration of the particle mesh method.}
